...
Private m_Button1Caption As String
Private m_Button2Caption As String
Private m_Button1Visible As Boolean
Private m_Button2Visible As Boolean
...
With UserControl
  ...
  'Button1
  If m_Button1Visible Then
    Button1.Left = .ScaleWidth - (.TextWidth(m_Button1Caption) + 25) * nScale
    Button1.Top = .ScaleHeight - (.TextHeight("Áj") + 20) * nScale
    Button1.Width = .TextWidth(m_Button1Caption) + 20 * nScale
    ...
    DrawString hGraphics, m_Button1Caption, stBt1, m_ForeColor, 100, 0, eCenter, eMiddle, True
  End If
  
  'Button2
  If m_Button2Visible Then
    Button2.Left = .ScaleWidth - (.TextWidth(m_Button2Caption) + Button1.Width + 40) * nScale
    Button2.Top = .ScaleHeight - (.TextHeight("Áj") + 20) * nScale
    Button2.Width = .TextWidth(m_Button2Caption) + 20 * nScale
    ...
    DrawString hGraphics, m_Button2Caption, stBt2, m_ForeColor, 100, 0, eCenter, eMiddle, True
  End If
...
With PropBag
  ...
  m_Button1Caption = .ReadProperty("Button1Caption", "Aceptar")
  m_Button2Caption = .ReadProperty("Button2Caption", "Cancelar")
  m_Button1Visible = .ReadProperty("Button1Visible", True)
  m_Button2Visible = .ReadProperty("Button2Visible", False)
...
With PropBag
  ...
  Call .WriteProperty("Button1Caption", m_Button1Caption, "Aceptar")
  Call .WriteProperty("Button2Caption", m_Button2Caption, "Cancelar")
  Call .WriteProperty("Button1Visible", m_Button1Visible)
  Call .WriteProperty("Button2Visible", m_Button2Visible)
...
Public Property Get Button1Caption() As String
  Button1Caption = m_Button1Caption
End Property

Public Property Let Button1Caption(ByVal NewButton1Caption As String)
  m_Button1Caption = IIF(NewButton1Caption = "", "Aceptar", NewButton1Caption)
  PropertyChanged "Button1Caption"
  DrawMessage
End Property

Public Property Get Button2Caption() As String
  Button2Caption = m_Button2Caption
End Property

Public Property Let Button2Caption(ByVal NewButton2Caption As String)
  m_Button2Caption = IIF(NewButton2Caption = "", "Cancelar", NewButton2Caption)
  PropertyChanged "Button2Caption"
  DrawMessage
End Property

Public Property Get Button1Visible() As Boolean
  Button1Visible = m_Button1Visible
End Property

Public Property Let Button1Visible(ByVal NewButton1Visible As Boolean)
  m_Button1Visible = NewButton1Visible
  PropertyChanged "Button1Visible"
  DrawMessage
End Property

Public Property Get Button2Visible() As Boolean
  Button2Visible = m_Button2Visible
End Property

Public Property Let Button2Visible(ByVal NewButton2Visible As Boolean)
  m_Button2Visible = NewButton2Visible
  PropertyChanged "Button2Visible"
  DrawMessage
End Property
